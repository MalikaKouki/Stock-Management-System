<div class="card card-outline card-primary">
	<div class="card-header">
        ...
        <!-- <div class="card-tools">
			<a href="<?php echo base_url ?>admin/?page=back_order/manage_bo" class="btn btn-flat btn-primary">
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        ...
                        FROM `back_order_list` p inner join supplier_list s on p.supplier_id = s.id order by p.`date_created` desc");
